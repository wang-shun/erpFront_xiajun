      ...
      <div>
        ...
        <Row className="operBtn">
          <Col>
            ...
            <Button type="primary" style={{ float: 'right', marginLeft: 10 }} disabled="dsiabled" size="large" onClick={p.batchAction.bind(p, 'syn')}>批量同步</Button>
            <Button type="primary" style={{ float: 'right', marginLeft: 10 }} disabled="dsiabled" size="large" onClick={p.batchAction.bind(p, 'onSell')}>批量上架</Button>
            <Button type="primary" style={{ float: 'right', marginLeft: 10 }} disabled="dsiabled" size="large" onClick={p.batchAction.bind(p, 'offSell')}>批量下架</Button>
          </Col>
        </Row>
        <Row>
